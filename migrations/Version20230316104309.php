 ...
 */
final class Version20230316104309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `table` (id INT AUTO_INCREMENT NOT NULL, nb_guests INT NOT NULL, date DATE NOT NULL, time TIME NOT NULL, allergy VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
