 ...
 */
final class Version20230522112908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, schedule_id INT DEFAULT NULL, user_id INT DEFAULT NULL, restaurant_id INT DEFAULT NULL, full_name VARCHAR(255) NOT NULL, nb_people INT NOT NULL, nb_children INT NOT NULL, date DATE NOT NULL, lunch_time VARCHAR(255) DEFAULT NULL, dinner_time VARCHAR(255) DEFAULT NULL, INDEX IDX_42C84955A40BC2D5 (schedule_id), INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE restaurant (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, nb_total_places INT NOT NULL, nb_available_places INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
