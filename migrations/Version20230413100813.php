 ...
 */
final class Version20230413100813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, tables_id INT NOT NULL, nb_people INT NOT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_42C8495585405FD2 (tables_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495585405FD2 FOREIGN KEY (tables_id) REFERENCES `table` (id)');
